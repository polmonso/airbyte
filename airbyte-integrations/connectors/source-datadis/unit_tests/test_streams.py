...
import pytest
from source_datadis.source import DatadisStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(DatadisStream, "path", "v0/example_endpoint")
    mocker.patch.object(DatadisStream, "primary_key", "test_primary_key")
    mocker.patch.object(DatadisStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = DatadisStream()
